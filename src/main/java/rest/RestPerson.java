...
public class RestPerson {
    ...
    public Response createPerson(String json) throws ParamaterNoMatchException {
        ...
        cityInfo.setCity(p.getCity());
        cityInfo.setZipCode(p.getZipCode());
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public Response addPhone(String json) {
        PhoneDTO p = gson.fromJson(json, PhoneDTO.class);
        fp.addPhone(p.getEmail(), p.getNumber());
        return Response.ok(json).build();
